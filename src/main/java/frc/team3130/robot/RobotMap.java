...
public class RobotMap {
	...
	//Chassis
		...
		public static double kMPChassisP = 10.0; //Checked 3/23
		public static double kMPChassisI = 0.0; //Checked 3/23
		public static double kMPChassisD = 0.0; //Checked 3/23
		public static double kMPChassisF = 0; //1023.0 / (92.0 * (kLChassisTicksPerInch + kRChassisTicksPerInch) / 2.0); //Checked 3/23
    ...
    public static final int CAN_LEFTMOTORFRONT = 6;
	...
	public static final int CAN_SHOOTERLEFT = 14;
	public static final int CAN_SHOOTERRIGHT = 15;
	public static final int CAN_SHOOTERTOP = 16;
